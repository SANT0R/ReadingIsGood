...
import com.msantor.bookshop.service.ClientService;
...
public class ClientController {
    ...
    public ResponseEntity<ClientDTO> getMe(@RequestBody ClientEntity entity) {
    ...
    @PreAuthorize("hasRole('ROLE_CLIENT')")
    public ResponseEntity<URI> deleteMe(@RequestBody ClientEntity entity) {
    ...
    @ApiOperation(value = "Get all orders of the client")
    ...
    public ResponseEntity<List<OrderDTO>> getAllOrders(@RequestParam Long id)  {
        ...
        try {
            ...
            List<OrderDTO> orderDTOList = entityService.getAllOrders(id);
    ...
    @ApiOperation(value = "Get all statistics of the client")
    @GetMapping("/getAllStatistics")
    @PreAuthorize("permitAll()")
    public ResponseEntity<List<Map<String,Object>>> getAllStatistics(@RequestParam Long id)  {

        try {

            List<Map<String,Object>> orderDTOList = entityService.getStatistics(id);
