package com.msantor.bookshop.config.security.Jwt;

import com.auth0.jwt.JWT;
import com.msantor.bookshop.config.security.MyUserPrincipal;
...
public class JwtAuthorizationFilter extends BasicAuthenticationFilter {
    ...
    private Authentication getUsernamePasswordAuthentication(HttpServletRequest request) {
        ...
        if (token != null) {
            ...
            if (userName != null) {
                ClientEntity user = userRepository.findByUserName(userName);
