...
class ClientRepositoryTest {
    ...
    private ClientEntity addEntity(String fullName){
    ...
    void addTest(){
        ...
        ClientEntity entity = entityRepository.getOne(firstId);
    ...
    void getByNameTest(){
        ...
        ClientEntity  entity = entityRepository.findByFullName("Mehmet Santor");
    ...
    void getAllTest() {
        ...
        ClientEntity entity1 = entityRepository.getOne(firstId);

        assertEquals(entity1.getId(), firstId);

        ClientEntity entity2 = entityRepository.getOne(firstId+1);

        assertEquals(entity2.getId(), firstId+1);

        ClientEntity entity3 = entityRepository.getOne(firstId+2);

        assertEquals(entity3.getId(), firstId+2);

        ClientEntity entity4 = entityRepository.getOne(firstId+3);
    ...
    void searchTest(){
        ...
        List<ClientEntity> expected = new ArrayList<>();
        expected.add(addEntity("Konyalı"));
        expected.add(addEntity("Urfalıyam Ezelden"));
        addEntity("Ağrılı halo");
        expected.add(addEntity("ya"));

        List<ClientEntity> actual = entityRepository.findByFullNameContains("ya");
